...
namespace HashTableTests
{
    ...
    public class ChangeTest
    {
        ...
        public void Change()
        {
            ...
            Assert.AreEqual(hash.hashTable[41].ReturnValue(0), "cut");
            Assert.AreEqual(hash.hashTable[41].ReturnValue(1), "tuc");
        }
        ...
        public void AddInChange()
        {
            ...
            Assert.AreEqual(hash.hashTable[47].ReturnValue(0), "hello");
        }
    }
}
